...
// ISRs
//ISR( USARTx_RX_vect )
ISR( USART0_RX_vect ){ //Rutina de servicio de interrupci�n para el evento de recepci�n completa. Esta rutina inserta a la cola circular el dato que fue recibido por el UARTx.
